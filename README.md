...
1. **Home — The National Coverage Story**: Key metrics, uninsured rate trends, coverage by type, marketplace enrollment surge, Medicaid monthly enrollment, and premium affordability.
2. **State Explorer**: Interactive state comparisons with filters for Medicaid expansion status. Includes marketplace enrollment, uninsured rates, expansion vs. non-expansion scatter, and growth rankings.
...
```
aca-dashboard/
├── Home.py                    # Main page: national coverage story
